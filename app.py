...
def edit_event(state,id):
    ...
    if save_button:
        ...
        st.session_state["events"][id]["start"] = st.session_state["events"][id]["start"][:16] + edit_start + ":00.000Z"
        st.session_state["events"][id]["end"] = st.session_state["events"][id]["end"][:16] + edit_end + ":00.000Z"
